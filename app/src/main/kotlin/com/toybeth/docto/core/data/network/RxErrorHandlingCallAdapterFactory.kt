package com.toybeth.docto.core.data.network
...
class RxErrorHandlingCallAdapterFactory(private val context: Context) : CallAdapter.Factory() {
    ...
    private inner class RxSingleCallAdapterWrapper<R>(
        val context: Context,
    ...
    private inner class RxFlowableCallAdapterWrapper<R>(
        val context: Context,
        val retrofit: Retrofit,
        val wrappedCallAdapter: CallAdapter<R, *>
    ...
    private inner class RxMaybeCallAdapterWrapper<R>(
        val context: Context,
        val retrofit: Retrofit,
        val wrappedCallAdapter: CallAdapter<R, *>
    ...
    private inner class RxObservableCallAdapterWrapper<R>(
        val context: Context,
        val retrofit: Retrofit,
        val wrappedCallAdapter: CallAdapter<R, *>
    ...
    private inner class RxCompletableCallAdapterWrapper<R>(
        val context: Context,
        val retrofit: Retrofit,
        val wrappedCallAdapter: CallAdapter<R, *>
