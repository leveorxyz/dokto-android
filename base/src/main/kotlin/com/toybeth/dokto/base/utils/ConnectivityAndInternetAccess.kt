package com.toybeth.dokto.base.utils
        ...
        fun isConnectionFast(type: Int, subType: Int): Boolean {
            ...
            connectedFast = if (type == ConnectivityManager.TYPE_WIFI
                ...
                when (subType) {
                    ...
                    TelephonyManager.NETWORK_TYPE_HSPAP, TelephonyManager.NETWORK_TYPE_LTE -> true
                    ...
                    TelephonyManager.NETWORK_TYPE_IDEN, TelephonyManager.NETWORK_TYPE_UNKNOWN -> false
                    else -> false
                }
            } else {
                false
