...
import com.toybethsystems.dokto.twilio.data.sdk.RoomStats
import com.toybethsystems.dokto.twilio.databinding.StatsViewBinding
import com.twilio.video.RemoteAudioTrack
import com.twilio.video.RemoteParticipant
import com.twilio.video.RemoteVideoTrack

class StatsListAdapter(private val context: Context) :
    RecyclerView.Adapter<StatsListAdapter.ViewHolder>() {
            ...
            for (report in statsReports) {
                if (!localTracksAdded) {
                    ...
                    for (localVideoTrackStats in report.localVideoTrackStats) {
                        var localVideoTrackName =
                            roomStats.localVideoTrackNames[localVideoTrackStats.trackSid]
                ...
                for (remoteAudioTrackStats in report.remoteAudioTrackStats) {
                    val trackName = (getParticipantName(
                        remoteAudioTrackStats.trackSid,
                        true,
