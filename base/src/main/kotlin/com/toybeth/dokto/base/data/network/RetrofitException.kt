...
class RetrofitException(
    ...
    class RequestException(var httpCode: Int = 500, override var message: String = "") :
        Exception(message)

    class ApiException(val code: Int, val errorBody: ResponseBody?, override val message: String) :
        Exception(message)
    ...
    companion object {
         ...
         */
        private fun <T> getConverter(
            appContext: Context,
            clazz: Class<T>,
            errorBody: ResponseBody
        ): T {
            return try {
                com.toybeth.dokto.base.data.network.NetworkFactory.getRetrofit(appContext)
