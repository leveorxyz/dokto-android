package com.toybeth.dokto.base.data.preference
...
class AppPreferenceImpl @Inject constructor(@ApplicationContext context: Context) :
    ...
    override var user: com.toybeth.dokto.base.data.model.DoktoUser
        get() = getObject(USER, com.toybeth.dokto.base.data.model.DoktoUser::class.java)
        set(value) {
